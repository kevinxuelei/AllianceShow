...
//        CGFloat itemW = [FDSlideBarItem widthForTitle:title];
        CGFloat itemW = self.frame.size.width / _itemsTitle.count;
        CGFloat gap = (self.frame.size.width - 4 * itemW) * 0.2;
        item.frame = CGRectMake(gap + itemX, 0, itemW, CGRectGetHeight(_scrollView.frame));
    ...
    _scrollView.contentSize = CGSizeMake(itemX, 0);
